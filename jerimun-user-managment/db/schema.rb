...
ActiveRecord::Schema[8.1].define(version: 2026_09_11_003112) do
  ...
  create_table "user_imports", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["created_by_id"], name: "index_user_imports_on_created_by_id"
  end
  ...
  add_foreign_key "user_imports", "users", column: "created_by_id"
end
